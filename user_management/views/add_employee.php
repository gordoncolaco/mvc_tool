...
<body>
    ...
    <form id="loginform" action="<?php echo Tools::getPageLink($ctg."/add"); ?>" method="post" name="register" onsubmit="return false" autocomplete="off" class="form_section">
		...
		<input type="hidden" name="formAction" value="employeeRegister" />
    </form>
</div>
<!--   -->
	<script>
